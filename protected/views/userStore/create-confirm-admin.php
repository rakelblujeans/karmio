 ...
 <div id="MainBody">
     ...
     <center>
		...
		<div class="modify_container">
			...
			<a href="<?php echo CController::createUrl('userStore/adminCreate', array('modify'=>1)); ?>"><div id="modify_link">MODIFY</div></a>
		</div>
		    ...
		    <p class="biz_confirm_text"><?php echo Yii::app()->session['business_owner_name']; ?></p>
                ...
                <a href="<?php echo CController::createUrl('userStore/adminCreate', array('confirmentry'=>1)); ?>">
