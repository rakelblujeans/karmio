...
<script type="text/javascript">
     ...
     {
          window.open(Yii::app()->getBaseUrl(true)); //'http://beta.karm.io/');
          location.href = Yii::app()->getBaseUrl(true); //'http://beta.karm.io/';
          window.location = Yii::app()->getBaseUrl(true); //'http://beta.karm.io/';
          jQuery(".errors").hide();
                    ...
                    <div class="SignInBox" >
                         ...
                         <div id="contact_form">
                              ...
                              <?php if ($form->errorSummary($model) != '') {
                                   ?>
                                   <div class="errors">
                                        <a class="close" href="<?php echo Yii::app()->getBaseUrl(true); ?>">close</a>
                                        <?php echo $form->errorSummary($model); ?>
                                   </div>
                              <?php } ?>

                              <div class="col_w310 float_l" style="margin: 0 0 15px 122px; padding: 70px 115px 19px 0; height:250px;">
                                   ...
                                   <div class="cleaner_h10"></div>
                                    ...
                                    <div style="width: 410px; float: left; margin:29px 0px 0px -29px;">
                                   <input style="margin:0px 0px 0px; " type="submit" class="submit_btns float_r" name="submit" id="submit" value="Submit" />                              		</div>
                              </div>
