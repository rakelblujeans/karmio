               ...
               <div id="HomePage">
                    ...
                    <div class="SignInBox">
                         <div id="contact_form">
                              ...
                              <h3 class="ARegTxt" style="margin: 35px 94px 0px;;">Sign In</h3> 
                              ...
                              <div class="col_w310 float_l" style="margin: 0px 0px 15px 122px; padding-right: 70px; padding-top: 22px; height: 250px;">
