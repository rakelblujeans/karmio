...
?>
  ...
  <div class="deal-suspend">
   <div class="plus-minus" id="plus-minus"><a id="imageDivLink-<?php echo $data->id; ?>" href="javascript:toggle('show-text-<?php echo $data->id; ?>', 'imageDivLink-<?php echo $data->id; ?>');"><img src="../admin/images/plus.png" alt="" border="0" /></a></div>
	...
	<div class="status-update">
		<form action="<?php echo CController::createUrl('/seller/dashboard'); ?>" id="dashboard-status-update-form" method="post">
			...
			?>
				...
				<input type="image" src="../admin/images/status_update_suspend.png" />
			<?php
			}
			else if ($data->status != 'suspended')
			{?>
				<input type="hidden" name="status_update" value="published" />
				<input type="image" src="../admin/images/status_update_publish.png" />
			<?php
			}?>
		</form>
	</div>
