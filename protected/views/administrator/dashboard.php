...
<?php if(isset(Yii::app()->user->isBuyer))
{?>
	<a href="#"><img src="../admin/images/nonprofit.jpg" border="0" /></a>
<?php }?>
</div>
<div class="clear"></div>
<div class="deal">
 ...
 <div style="height:202px; border-bottom: #41b0e5 solid 17px;">
    ...
    <div>
		<form action="<?php echo CController::createUrl('/seller/dashboard'); ?>" id="dashboard-status-form" method="post">
			<input type="image" src="../admin/images/published.png" name="published"/>
			<input type="image" src="../admin/images/holding.png" style="margin-left:35px" name="holding"/>
			<input type="image" src="../admin/images/suspended.png" style="margin-left:35px" name="suspended"/>
			<input type="image" src="../admin/images/unpublished.png" style="margin-left:35px" name="unpublished"/>
		</form>
    </div>
 </div>
