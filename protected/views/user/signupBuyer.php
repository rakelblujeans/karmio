        ...
        <div class="HundredPercent">
            <div id="HomePage">
                ...
                <div class="SignInBox" >
                    ...
                    <div id="contact_form">
                        <h3 class="ARegTxt" style="margin: 9px 75px 0px; padding-bottom: 10px;">Register</h3>
                        <?php
                        ...
                        <div class="col_w310 float_l" style="margin: 0 0 15px 95px; padding: 20px 100px 19px 0;">
                            ...
                            <label for="author">Enter Captcha Code:</label> 
                            <div class="for RegisterFieldBox">
                                <?php if(CCaptcha::checkRequirements()): ?>
                                    <?php $this->widget('CCaptcha'); ?>
                                    <?php echo $form->textField($model,'captcha_code', array('class' => 'input')); ?>
                                <?php endif; ?>
                            </div>
                            <div class="cleaner_h10"></div>
                            
                            <div class="remember"><input type="checkbox" id="terms"><span>I read and agree with <a href="<?php echo CController::createUrl('site/terms') ?>">terms and conditions</a></span></div>
