                    ...
                    <div class="SignInBox">
                         ...
                         <div id="Profile_form">
                              ...
                              <?php if ($msg == 'successful') { ?>
                                   ...
                                   <h1 style="margin-left:4px; color:#0C0; text-align:center;">Information updated successfully </h1>

                              <?php } else if ($msg == 'Error') {
                                   ?>
                                   <h1 style="margin-left:4px; color:#ff0033; text-align:center;"> Error! Information Not updated. </h1>      
                              ...
                              <div class="col_w310 float_l">
                                   ...
                                   <?php echo $form->textField($model, 'email', array('class' => 'input','disabled'=>true)); ?>
                                   ...
                                   <?php echo $form->textField($model, 'cellphone', array('class' => 'input')); ?>
                              ...
                              <div class="col_w311 float_l">
                                   ...
                                   <div class="col_w6">
                                        ...
                                        <?php echo $form->textField($model, 'state_id', array('class' => 'inputSmallS float_l', 'maxlength' => 2)); ?>
                                   ...
                                   <div class="col_w6">
                                        ...
                                        <?php echo $form->textField($model, 'zip', array('class' => 'inputSmallS float_l', 'maxlength' => 5)); ?>
