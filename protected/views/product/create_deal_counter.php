                                  ...
                                  <tr>
                                    <td align="center" valign="top">
                                        ...
                                        <span class="hint"> Max 140 characters (<div id="charNum">140</div>)</span>
                                		 <?php 
echo $form->textArea($model,'description',array('maxlength'=>140, 'class'=>'TextareaStyle', 'id'=>'title', 'onchange' => 'setText(this, "name")', 'onkeyup' => 'countChar(this)'));
echo $form->hiddenField($model, 'name', array('value' => $user->storeName)); ?>
                                  ...
                                  <tr>
                                    <td align="center" valign="top">
                                		...
                                		<?php 
echo $form->textArea($model,'fine_print',array('maxlength'=>500, 'class'=>"TextareaStyle", 'id'=>'fine_print', 'onchange' => 'setText(this, "fine_print")', 'onkeyup' => 'countChar1(this)')); ?>
                                    </td>
                                  </tr>
...
<div style="height:186px; display:block;"></div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ChooseCharity">
                                  ...
                                  <tr>
                                  <!--onclick="showSearch()"-->
                                    <td align="center" valign="top" height="146px">
                                  <h3 id="mycharity" style="margin-top:20px;" ></h3>
                                    </td>
                                  </tr>
