...
?>
 ...
 <div class="sold-price">
   ...
   <div class="time-remaining"><?php //echo $t->remainingTime(); ?><br /><span class="checked"></span></div>
  </div>
   <div class="result-right">
   <div class="pro-image"><img src="images/orgLogos/<?php // echo CHtml::encode($t->logo);  ?>" alt="" /></div>
  </div>
  <br style="clear:both" />
