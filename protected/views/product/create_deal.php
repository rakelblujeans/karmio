...
<div style="height:186px; display:block;"></div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ChooseCharity">
                                  ...
                                  <tr>
                                    ...
                                    <div class="main">
                                    <a href="javascript:void(0)" onclick="showSearch();"><span class="btn_back" style="height: 22px; margin-left: 85px; margin-top: 100px;     padding-top: 15px; width: 130px;" > PARTNER CHARITIES</span></a>
                                    <span class="btn_or"> or </span>
                                    
                                    <a href="javascript:void(0)" onclick="setCharity2(this);"><span class="btn_next" style="margin-right:85px; margin-top:100px;" > LET THE BUYER<br />CHOOSE THEIR OWN</span></a>
                                    </div>
                                    </td>
                                  </tr>
                                  <tr>
