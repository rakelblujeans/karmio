 ...
 */
  ...
  */
  ...
  $merchant_id = "231472301732456";  // Your Merchant ID
  $merchant_key = "IBqB_0-KG-V2hz7SntV2Fw";  // Your Merchant Key
  ...
  switch ($root) {
    ...
    case "new-order-notification": {
       ...
       $e_hid_host_pack_price = $data[$root]['shopping-cart']['merchant-private-data']['VALUE'];

       list($pId,$userId,$paid,$donated,$quantity,$expiry_date,$invoice) = explode(',', $e_hid_host_pack_price);
	   
		$user="root";
$password="OneHundred10";
$database="admin_karmio";
$hostname = "localhost"; 
$con=mysql_connect($hostname,$user,$password);
mysql_select_db($database);
  $query="insert into tbl_user_purchase (product_id,user_id,transaction_method,transaction_id,transaction_status,paid_price,donated,quantity,expiry_date,invoice_id) values ('".$pId."','".$userId."','google','".$google_order_number."','New','".$paid."','".$donated."','".$quantity."','".$expiry_date."','".$invoice."')";
  ...
  $Gresponse->SendAck();
    ...
    case "order-state-change-notification": {
      ...
      switch($new_financial_state) {
        ...
        case 'CHARGED': {
		$transid = $Grequest->SendProcessOrder($data[$root]['google-order-number']['VALUE']);
...
mysql_select_db($database);
  ...
  $query="update tbl_user_purchase set 	transaction_status='CHARGED' where transaction_id= $transid";
  mysql_query($query,$con);
